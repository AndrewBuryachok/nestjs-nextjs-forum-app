  ...
  return (
    <ViewForm>
      ...
      <Field.Root>
        ...
        <CardInput
          user={props.order.customerUser}
          card={props.order.customerCard}
        />
      </Field.Root>
      <Field.Root>
      ...
      <Field.Root>
        ...
        {props.order.executorUser && props.order.executorCard ? (
          <CardInput
            user={props.order.executorUser}
            card={props.order.executorCard}
          />
        ) : (
