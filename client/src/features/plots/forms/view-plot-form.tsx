  ...
  return (
    <ViewForm>
      ...
      <Field.Root>
        ...
        <CardInput
          user={props.plot.market.user}
          card={props.plot.market.card}
        />
      </Field.Root>
      <Field.Root>
      ...
      <Field.Root>
        ...
        <PlaceInput place={props.plot.market} />
      </Field.Root>
      <Field.Root>
      ...
      <Field.Root>
        ...
        {props.plot.reservedUntil ? (
          <DateInput value={props.plot.reservedUntil} />
        ) : (
